...
static RAMNOINIT_D1 __ALIGN_BEGIN uint32_t                   keybd_rx_report_buf[2] __ALIGN_END;
static RAMNOINIT_D1 __ALIGN_BEGIN	uint32_t                   keybd_report_data[2] __ALIGN_END;
