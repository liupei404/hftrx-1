...
static RAMNOINIT_D1 __ALIGN_BEGIN uint8_t touch_report_data [64] __ALIGN_END;
static RAMNOINIT_D1 __ALIGN_BEGIN uint8_t touch_rx_report_buf [64] __ALIGN_END;
